...
import '../models/kpi_layout_model.dart';
...
class DashboardRepositoryImpl implements DashboardRepository {
  ...
  @override
  Future<(List<KpiPref>?, DashboardFailure?)> loadKpiLayout() async {
    try {
      final raw = await _ds.loadKpiLayout();
      return (KpiLayoutModel.fromJson(raw), null);
    } catch (e) {
  ...
  @override
  Future<DashboardFailure?> saveKpiLayout(List<KpiPref> layout) async {
    try {
      await _ds.saveKpiLayout(KpiLayoutModel.toJson(layout));
      return null;
    } catch (e) {
      return _mapError(e);
    }
