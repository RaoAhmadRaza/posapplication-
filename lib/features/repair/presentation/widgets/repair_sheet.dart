...
/// below the module breakpoint. One helper so every repair dialog behaves the
/// same way instead of each page rolling its own [AlertDialog].
...
/// Title + optional subtitle heading a repair dialog.
class RepairSheetHeader extends StatelessWidget {
  const RepairSheetHeader({super.key, required this.title, this.subtitle});
