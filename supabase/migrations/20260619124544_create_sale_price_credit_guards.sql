-- <ts>_create_sale_price_credit_guards.sql
-- Replaces create_sale: adds (R3) min_selling_price floor and (R4, optional) credit_limit ceiling.
-- Both overridable by sales:approve (manager). Everything else identical to the S1 version.
