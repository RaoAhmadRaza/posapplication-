-- FIX: disburse_payroll_run stored post_journal's jsonb return directly into a uuid var
-- (v_je uuid), raising 22P02 "invalid input syntax for type uuid". post_journal returns
-- jsonb {total, entry_number, journal_entry_id} — extract ->>'journal_entry_id'.
